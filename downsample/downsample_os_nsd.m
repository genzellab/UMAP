...
folderpath_raw_data='/mnt/genzel/Rat/OS/OS_rat_ephys' % 3 4 5 6
folderpath_downsampled_data='/home/genzel/Documents/UMAP_NSD';


cd(folderpath_downsampled_data)
load('OS_NSD_RAT6.mat'); %ADAPT TO RAT ACCORDINGLY
% OS_NSD: RAT 3 AND 4 (HC, OR ,OD, CON)
% OS_NSD_RAT5: RAT 5 (HC, OR)
% OS_NSD_RAT6 RAT 6 (HC, OR, CON)
