function [sd_swr,signal2_hpc,signal2_pfc]=find_stdPFC(HPC,PFC,states,ss,fn)
...
%Band pass filter design: HPC
%fn=2500; % New sampling frequency. 
Wn1=[100/(fn/2) 300/(fn/2)]; % Cutoff=100-300 Hz
% Wn1=[50/(fn/2) 80/(fn/2)]; 
[b1,a1] = butter(3,Wn1,'bandpass'); %Filter coefficients

%Band pass filter design: PFC
%fn=2500; % New sampling frequency. 
Wn1=[0.5/(fn/2) 6/(fn/2)]; % Cutoff=100-300 Hz
% Wn1=[50/(fn/2) 80/(fn/2)]; 
